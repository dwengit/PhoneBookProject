...
using PhoneBookProject.Web.Models.Account;
using PhoneBookProject.Web.Views.Shared.Components.TenantChange;

namespace PhoneBookProject.Web.Controllers
{
    public class AccountController : PhoneBookProjectControllerBase
    {
